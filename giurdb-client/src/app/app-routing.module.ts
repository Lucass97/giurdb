...
import {InsertMassimaComponent} from "./insert-massima/insert-massima.component";
import {SearchMassimaComponent} from "./search-massima/search-massima.component";

const routes: Routes = [
  {path:'',redirectTo:'/login',pathMatch:'full'},
  { path: 'login', component: LoginComponent },
  {path:'forbidden',component :ForbiddenComponent},
  { path: 'insert-massima', component: InsertMassimaComponent},
  { path: 'search-massima', component: SearchMassimaComponent},
  { path: 'updatePf', component: UpdatePfComponent},
  ...
  { path:'app_old',component:MainDashboardComponent,
